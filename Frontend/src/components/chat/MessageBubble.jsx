...
const MessageBubble = ({ message, isOwnMessage, showAvatar = true, isLastInGroup = true }) => {
  ...
  const getStatusIcon = () => {
    ...
    if (messageStatus.read) {
      return (
        <svg className="w-3 h-3 text-blue-500" fill="currentColor" viewBox="0 0 20 20" title="Read">
          <path d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" />
          <path d="M13.707 2.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 9.586l7.293-7.293a1 1 0 011.414 0z" />
        </svg>
      );
    } else if (messageStatus.delivered) {
      return (
        <svg className="w-3 h-3 text-gray-500" fill="currentColor" viewBox="0 0 20 20" title="Delivered">
          <path d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" />
          <path d="M13.707 2.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 9.586l7.293-7.293a1 1 0 011.414 0z" />
        </svg>
      );
