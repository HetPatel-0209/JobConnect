...
const CompanyDetails = () => {
  ...
  return (
    <main className="mt-28">
      <div className="max-w-4xl mx-auto mb-8 bg-white p-8 rounded-xl shadow-lg">
          {/* Success Message */}
          {showSuccess && (
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full px-4 py-3 border rounded-lg text-base transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${errors.logo ? 'border-red-300 bg-red-50' : 'border-gray-300'
                      }`}
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full px-4 py-3 border rounded-lg text-base transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${errors.banner ? 'border-red-300 bg-red-50' : 'border-gray-300'
                      }`}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full px-4 py-3 border rounded-lg text-base transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${errors.website ? 'border-red-300 bg-red-50' : 'border-gray-300'
                    }`}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full px-4 py-3 border rounded-lg text-base transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${errors.linkedin ? 'border-red-300 bg-red-50' : 'border-gray-300'
                    }`}
